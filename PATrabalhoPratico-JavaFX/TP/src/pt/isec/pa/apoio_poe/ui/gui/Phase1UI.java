...
public class Phase1UI extends BorderPane {
    ...
    private void createView(){
        ...
        btnProx.setBackground(new Background(new BackgroundFill(Color.GRAY, CornerRadii.EMPTY, Insets.EMPTY)));

        btnClose = new Button("Fecha Fase");
        btnClose.setMinWidth(100);
        btnClose.setBackground(new Background(new BackgroundFill(Color.GRAY, CornerRadii.EMPTY, Insets.EMPTY)));
        ...
        HBox hBox2 = new HBox();
        hBox2.getChildren().addAll(btnProx, displayTipo, btnClose);
